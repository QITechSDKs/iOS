Pod::Spec.new do |s|
  ...
  s.source       = { :http => "https://sdks.sandbox.qitech.com.br/com/qitech/ios/QITechIosFaceRecon/8.3.0-rc2/QITechIosFaceRecon.xcframework.zip" }
  ...
  s.dependency "QITechIosDeviceScan", '~> 6.2'
